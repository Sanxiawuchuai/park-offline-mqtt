...
public class ClientMQTTTest {
	...
	public static final String HOST = "tcp://192.168.1.89:1883";
		...
		try {
			...
			client.setCallback(new MqttCallback() {
				...
				public void messageArrived(String topic, MqttMessage message) throws Exception {
					...
					//
					vo.setTopic(topic);
					vo.setContent(new String(message.getPayload()));
					// mess = new String(message.getPayload());
	...
	public static void main(String[] args) throws MqttException {
		ClientMQTTTest client = new ClientMQTTTest();
		client.start();
	}
}
